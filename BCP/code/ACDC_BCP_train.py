...
parser.add_argument('--alpha', type=float, default=0.0, help='weight of original loss is (1-alpha), new loss is alpha')
...
if __name__ == "__main__":
    ...
    # -- path to save models
    pre_snapshot_path = "./ACDC_result/pretrain_{}_{}/pretrain".format(args.labelnum, args.pretrain_model)
    self_snapshot_path = "./ACDC_result/pretrain_{}_{}/self_train_{}_{}".format(args.labelnum, args.pretrain_model, args.model, args.alpha)
