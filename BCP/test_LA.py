...
parser.add_argument('--pretrain_model', type=str,  default='VNet', help='model_name')
...
parser.add_argument('--ema', type=float, default=0.99, help='lambda for EMA')

FLAGS = parser.parse_args()

os.environ['CUDA_VISIBLE_DEVICES'] = FLAGS.gpu
snapshot_path = "./LA_result_{}_encoder/pretrain_{}_{}/self_train_{}_{}".format(FLAGS.alpha, FLAGS.labelnum, FLAGS.pretrain_model, FLAGS.model, FLAGS.alpha)
test_save_path = "./LA_result_{}_encoder/pretrain_{}_{}/self_train_{}_{}/prediction".format(FLAGS.alpha, FLAGS.labelnum, FLAGS.pretrain_model, FLAGS.model, FLAGS.alpha)
num_classes = 2
