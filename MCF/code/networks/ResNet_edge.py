...
class Resnet34(nn.Module):
    def __init__(self, resnet_encoder=None, n_channels=3, n_classes=2, n_filters=16, normalization='none', has_dropout=False):
        ...
        self.decoder = Decoder(n_channels, n_classes, n_filters, normalization, has_dropout)
        self.decoder_edge = Decoder(n_channels, n_classes, n_filters, normalization, has_dropout)
    ...
    def forward(self, input, batch_size=4):
        ...
        edge = self.decoder_edge(resnet_features)
        return out, edge
