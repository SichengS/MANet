...
parser.add_argument('--exp', type=str,  default="baseline", help='model_name')                               # todo model name
...
parser.add_argument('--label_num', type=int, default=8, help='number of labeled data')
### costs
...
if __name__ == "__main__":
    ...
    for epoch_num in tqdm(range(max_epoch), ncols=70):
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            v_outputs, _ = model_vnet(v_input)
            r_outputs, _ = model_resnet(r_input)
