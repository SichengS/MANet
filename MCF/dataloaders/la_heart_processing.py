...
def covert_h5():
    listt = glob('.\data\2018_Atrial_Segmentation_Challenge_COMPLETE_DATASET\Training Set\\*\lgemri.nrrd')
    for item in tqdm(listt):
        ...
        print(label.shape)
        save_dir = item.replace('lgemri.nrrd', 'mri_norm0_255.h5')
        save_dir = save_dir.replace('Training Set','h5_data_unint8')
